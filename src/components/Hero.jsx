...
const Hero = () => {
  const [text, count] = useTypewriter({
    words: [
      "<CodeArchitect />",
      "AIEnthusiast & MLPractitioner",
      "WebDevWizard",
      "CraftingSmartSolutions",
      "DataDrivenDeveloper",
      "TechExplorer & ProblemSolver",
      "InnovatingWithPurpose",
      "FromPythonToJava",
      "BuildingImpactfulApps",
      "CreatingWithReactAndNode",
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            ...
            <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black">
               <span className="hidden sm:inline">Arsath</span>
            </span>
          </h1>
      ...
      <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-5 items-center md:mt-10 mt-5 md:gap-12">
        <Link target="_blank" to="https://www.linkedin.com/in/arsath02/">
          <BsLinkedin
            size={30}
        ...
        <Link target="_blank" to="https://github.com/arsath-02">
          <BsGithub
            size={30}
        ...
        <Link target="_blank" to="https://discord.com/channels/@arsath9578">
          <BsDiscord
            size={30}
        ...
        <Link target="_blank" to="https://www.instagram.com/_.h.arsath/">
          <BsInstagram
            size={30}
